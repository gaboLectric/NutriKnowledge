...
public class HighlightUtils {
    ...
    public static class HighlightItem {
        ...
        public String toStorageString() {
            return text + ":::" + color + ":::" + topicTitle + ":::" + topicContent + ":::" + topicUrl;
        }
        public static HighlightItem fromStorageString(String s) {
            String[] parts = s.split(":::");
            // fallback for old highlights
            ...
            return new HighlightItem(text, color, topicTitle, topicContent, topicUrl);
        }
    }

    public static void addHighlight(SharedPreferences prefs, String text, String color, String topicTitle, String topicContent, String topicUrl) {
        List<String> highlights = getRawHighlights(prefs);
        String storage = text + ":::" + color + ":::" + topicTitle + ":::" + topicContent + ":::" + topicUrl;
